    ...
    <div style={{ minHeight: "100vh", background: "#f8fafc", fontFamily: "inherit" }}>
      <div style={{ maxWidth: 800, margin: "0 auto", padding: "48px 24px" }}>
       ...
       <ul>
          ...
          <p>The Platform facilitates connections between patients and healthcare professionals. Clinical decision support insights are for informational purposes only and do not constitute medical advice, diagnosis, or treatment. Always consult a qualified healthcare professional for medical decisions. Ahava Healthcare is not liable for outcomes arising from reliance on system-generated content.</p>
          ...
          <p>All Platform content, including software, design, and clinical decision support systems, is owned by Ahava Healthcare or its licensors. You may not copy, distribute, or create derivative works without written permission.</p>
