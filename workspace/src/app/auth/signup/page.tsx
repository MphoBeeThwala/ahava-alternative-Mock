    ...
    return (
        <div style={{ display: 'flex', minHeight: '100vh', fontFamily: 'inherit' }}>
            ...
            <div style={{ flex: '0 0 40%', background: 'linear-gradient(160deg,#0a1628 0%,#0d2f5e 55%,#0a3d3a 100%)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '60px 44px', position: 'relative', overflow: 'hidden' }}>
                <div style={{ position: 'absolute', top: -100, right: -80, width: 300, height: 300, borderRadius: '50%', background: 'radial-gradient(circle,rgba(13,148,136,0.15),transparent 70%)', pointerEvents: 'none' }} />
                ...
                <div style={{ position: 'relative', zIndex: 1, textAlign: 'center', maxWidth: 300 }}>
                    <div style={{ width: 72, height: 72, borderRadius: 20, background: 'linear-gradient(135deg,#0d9488,#059669)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 32, margin: '0 auto 24px' }}>⚕️</div>
            ...
            <div style={{ flex: 1, background: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '48px 40px', overflowY: 'auto' }}>
                <div style={{ width: '100%', maxWidth: 420 }}>
                    <Link href="/" style={{ color: '#a8a29e', fontSize: 13, fontWeight: 600, textDecoration: 'none', display: 'flex', alignItems: 'center', gap: 6, marginBottom: 32 }}>
                        ← Back to home
                    </Link>

                    <div style={{ marginBottom: 28 }}>
                        <h1 style={{ fontSize: 26, fontWeight: 900, color: '#1c1917', marginBottom: 6 }}>Create your account</h1>
                        <p style={{ fontSize: 14, color: '#57534e' }}>Free forever · No credit card required</p>
                    </div>
                    ...
                    <form style={{ display: 'flex', flexDirection: 'column', gap: 16 }} onSubmit={handleSubmit}>
                        ...
                        <div style={{ display: 'flex', gap: 12 }}>
                            <div style={{ flex: 1 }}>
                                <label htmlFor="signup-first" style={{ display: 'block', fontSize: 13, fontWeight: 600, color: '#374151', marginBottom: 6 }}>First name</label>
                                <input id="signup-first" type="text" required autoComplete="given-name" placeholder="Sipho"
                            ...
                            <div style={{ flex: 1 }}>
                                <label htmlFor="signup-last" style={{ display: 'block', fontSize: 13, fontWeight: 600, color: '#374151', marginBottom: 6 }}>Last name</label>
                                <input id="signup-last" type="text" required autoComplete="family-name" placeholder="Ndlovu"
                        ...
                        {/* Email */}
                        <div>
                            <label htmlFor="signup-email" style={{ display: 'block', fontSize: 13, fontWeight: 600, color: '#374151', marginBottom: 6 }}>Email address</label>
                        ...
                        {/* Password */}
                        <div>
                            <label htmlFor="signup-password" style={{ display: 'block', fontSize: 13, fontWeight: 600, color: '#374151', marginBottom: 6 }}>Password</label>
                            <input id="signup-password" type="password" required autoComplete="new-password" placeholder="••••••••"
                        ...
                        {/* Role */}
                        <div>
                            <label htmlFor="signup-role" style={{ display: 'block', fontSize: 13, fontWeight: 600, color: '#374151', marginBottom: 6 }}>I am a</label>
                            <select id="signup-role"
                                value={formData.role} onChange={(e) => setFormData({ ...formData, role: e.target.value as typeof formData.role })}
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            style={{ width: '100%', background: loading ? '#a8a29e' : 'linear-gradient(135deg,#0d9488,#059669)', border: 'none', color: 'white', borderRadius: 10, padding: '13px 20px', fontSize: 15, fontWeight: 700, cursor: loading ? 'not-allowed' : 'pointer', fontFamily: 'inherit', boxShadow: '0 4px 14px rgba(13,148,136,0.3)', marginTop: 4 }}
                        >
                            {loading ? 'Creating account…' : 'Create Free Account →'}
                        </button>
                    </form>

                    <p style={{ textAlign: 'center', marginTop: 20, fontSize: 13, color: '#57534e' }}>
                        Already have an account?{' '}
                        <Link href="/auth/login" style={{ color: '#0d9488', fontWeight: 700, textDecoration: 'none' }}>Sign in</Link>
                    </p>
                    <p style={{ textAlign: 'center', marginTop: 12, fontSize: 11, color: '#a8a29e' }}>
