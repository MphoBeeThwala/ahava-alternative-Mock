  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await register({
        ...
        role: formData.role,
        ...(isStaffRole && formData.registrationKey
          ? { adminSecret: formData.registrationKey }
          : {}),
      });
      ...
      >
        <div style={{ width: "100%", maxWidth: 420 }}>
          ...
          >
            ...
            {/* Registration Key — only for staff roles */}
            {isStaffRole && (
              <div>
                <label
                  htmlFor="signup-reg-key"
                  style={{
                    display: "block",
                    fontSize: 13,
                    fontWeight: 600,
                ...
                >
                  Registration Key <span style={{ color: "#ef4444" }}>*</span>
                </label>
                <input
                  id="signup-reg-key"
                  type="password"
                  required
                  autoComplete="off"
                  placeholder="Enter your staff registration key"
                ...
                />
                <p style={{ fontSize: 11, color: "#78716c", marginTop: 5 }}>
                  🔐 {formData.role === "ADMIN" ? "Admin" : "Staff"} accounts
                  require a registration key issued by Ahava Healthcare.
                </p>
              </div>
            )}
