...
import { runValidationTests, generateValidationReport, getTestStatistics } from './evidenceProvider/validation';
import { getProviderRegistry, getEnabledProviders } from './evidenceProvider/registry';
...
');
    ...
    if (stats.passed === stats.total) {
        ...
        console.log('✅ MOST TESTS PASSED (' + ((stats.passed / stats.total) * 100).toFixed(1) + '%)');
        ...
        console.log('⚠️  SOME TESTS FAILED (' + ((stats.passed / stats.total) * 100).toFixed(1) + '%)');
        ...
        console.log('❌ MOST TESTS FAILED (' + ((stats.passed / stats.total) * 100).toFixed(1) + '%)');
